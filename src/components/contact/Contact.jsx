        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">tamezdeen@gmail.com</span>
              <a href="mailto:tamezdeen@gmail.com" className="contact__button">
                Email me
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+94 767 611 079</span>
              <a href="tel:94767611079" className="contact__button">
                Call me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
